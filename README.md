...
The real human prototype is implemented based on Meta Passthrough Camera API sample projects, the license of the Meta's sample project is kept and followed in this project.
