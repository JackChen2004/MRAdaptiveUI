...
This project incorporates software from the Oculus SDK developed by Meta Platforms, Inc.
Copyright (c) Meta Platforms, Inc. and affiliates. All rights reserved.
This portion of the software is licensed under the Oculus SDK License Agreement, which can be found at: https://developer.oculus.com/licenses/oculussdk/. Use of this software is subject to the terms and conditions defined in that license.
