...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class DetectionManager : MonoBehaviour
    {
        ...
        [Space(10)]
        [SerializeField] private bool m_enableActionButtonToSpawnMarkers = false;
        ...
        private void Update()
        {
            ...
            else
            {
                ...
                if (m_enableActionButtonToSpawnMarkers && OVRInput.GetUp(m_actionButton) && m_delayPauseBackTime <= 0)
                {
